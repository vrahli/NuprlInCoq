...
Lemma uniquely_valued_per_bar_per_eq {o} :
  forall (ts : cts(o)) uk lib T T1 T2 eq1 eq2 a1 a2 A B eqa,
    in_ext_ext lib (fun lib' x => type_sys_props4 ts uk lib' A B (eqa lib' x))
    -> ccomputes_to_valc_ext lib T (mkc_equality a1 a2 A)
    -> per_bar (per_eq ts) uk lib T T1 eq1
    -> per_bar (per_eq ts) uk lib T T2 eq2
    -> (eq1 <=2=> eq2).
Proof.
...
Lemma ccequivc_ext_implies_per_eq1 {o} :
  forall (ts : cts(o)) uk lib T0 T T' T3 eq a1 a2 A b1 b2 B (eqa : lib-per(lib,o)),
    ccomputes_to_valc_ext lib T (mkc_equality a1 a2 A)
...
Lemma type_value_respecting_trans_per_bar_per_eq1 {o} :
  forall uk lib (ts : cts(o)) T T1 T2 A A' B a1 a' a2 b' (eqa : lib-per(lib,o)) eq,
    in_ext_ext lib (fun lib' x => type_sys_props4 ts uk lib' A B (eqa lib' x))
    ...
    -> per_bar (per_eq ts) uk lib T1 T2 eq
    -> per_bar (per_eq ts) uk lib T T2 eq.
Proof.
...
Lemma type_value_respecting_trans_per_bar_per_eq2 {o} :
  forall uk lib (ts : cts(o)) T T1 T2 A A' B a1 a' a2 b' (eqa : lib-per(lib,o)) eq,
    ...
    -> ccequivc_ext lib a2 b'
    -> ccequivc_ext lib A A'
    -> per_bar (per_eq ts) uk lib T2 T1 eq
    -> per_bar (per_eq ts) uk lib T T2 eq.
Proof.
  introv tsp comp1 comp2 ceq1 ceq2 ceq3 per.
  unfold per_bar in *; exrepnd.
...
Lemma type_symmetric_per_bar_per_eq1 {o} :
  forall uk lib (ts : cts(o)) T T' A B a1 a2 (eqa : lib-per(lib,o)) eq,
    in_ext_ext lib (fun lib' x => type_sys_props4 ts uk lib' A B (eqa lib' x))
    -> ccomputes_to_valc_ext lib T (mkc_equality a1 a2 A)
...
Lemma type_transitive_per_bar_per_eq1 {o} :
  forall uk lib (ts : cts(o)) T T1 T2 A B a1 a2 (eqa : lib-per(lib,o)) eq1 eq2,
    in_ext_ext lib (fun lib' x => type_sys_props4 ts uk lib' A B (eqa lib' x))
    -> ccomputes_to_valc_ext lib T (mkc_equality a1 a2 A)
    -> per_bar (per_eq ts) uk lib T1 T eq1
    -> per_bar (per_eq ts) uk lib T T2 eq2
    -> per_bar (per_eq ts) uk lib T1 T2 eq1.
Proof.
...
Lemma type_transitive_per_bar_per_eq2 {o} :
  forall uk lib (ts : cts(o)) T T1 T2 A B a1 a2 (eqa : lib-per(lib,o)) eq1 eq2,
    ...
    -> per_bar (per_eq ts) uk lib T1 T eq1
    -> per_bar (per_eq ts) uk lib T T2 eq2
    -> per_bar (per_eq ts) uk lib T1 T2 eq2.
Proof.
  introv tsp comp1 pera perb.
  unfold per_bar in *; exrepnd.
  exists eqa0; dands; auto.
...
Lemma implies_type_equality_respecting_trans1_per_eq {o} :
  forall uk lib ts (T T' : @CTerm o) A B a1 a2 b1 b2 (eqa : lib-per(lib,o)),
    type_system ts
...
Lemma type_value_respecting_trans_per_bar_per_eq3 {o} :
  forall uk lib (ts : cts(o)) T T1 T2 A B a b (eqa : lib-per(lib,o)) eq,
    in_ext_ext lib (fun lib' x => type_sys_props4 ts uk lib' A B (eqa lib' x))
    -> ccomputes_to_valc_ext lib T (mkc_equality a b A)
    -> ccequivc_ext lib T1 T2
    -> per_bar (per_eq ts) uk lib T T1 eq
    -> per_bar (per_eq ts) uk lib T T2 eq.
Proof.
