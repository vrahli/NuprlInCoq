...
Lemma per_atom_bar_implies_close {o} :
  forall (ts : cts(o)) uk lib T T' eq,
    per_atom_bar (close ts) uk lib T T' eq
...
Lemma type_equality_respecting_trans1_per_atom_bar_implies {o} :
  forall (ts : cts(o)) uk lib T T',
    ...
    -> ccomputes_to_valc_ext lib T mkc_atom
    -> ccomputes_to_valc_ext lib T' mkc_atom
    -> type_equality_respecting_trans1 (per_atom_bar (close ts)) uk lib T T'
...
Lemma type_equality_respecting_trans2_per_atom_bar_implies {o} :
  forall (ts : cts(o)) uk lib T T',
    ...
    -> ccomputes_to_valc_ext lib T mkc_atom
    -> ccomputes_to_valc_ext lib T' mkc_atom
    -> type_equality_respecting_trans2 (per_atom_bar (close ts)) uk lib T T'
