...
Proof.
  ...
  - SCase "term_symmetric".
    ...
    apply (per_union_eq_bar_symmetric _ (trivial_bar lib)); eauto 3 with slow.

  - SCase "term_transitive".
    introv ee1 ee2.
    apply eqiff in ee1; apply eqiff in ee2; apply eqiff; clear eqiff.
    eapply (per_union_eq_bar_transitive _ (trivial_bar lib)); eauto 3 with slow.

  - SCase "term_value_respecting".
    introv ee ceq.
    apply eqiff in ee; apply eqiff.
    eapply (per_union_eq_bar_cequiv _ (trivial_bar lib) (trivial_bar lib)); eauto 3 with slow.
