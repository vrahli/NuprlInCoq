...
Proof.
  ...
  discover; auto.
  apply MEQIH with (t2 := mkcn_apply f' b); auto.
Qed.
...
Proof.
  ...
  apply I in eb'.
  generalize (MEQIH (mkcn_apply f b) (mkcn_apply f1 b') eb' (mkcn_apply f2 b'));
...
Proof.
  ...
  + SCase "uniquely_valued".
    ...
    generalize (eq_term_equals_type_family lib T T3 eqa0 eqa eqb0 eqb (close lib ts) A v B A' v' B' mkcn_m); intro i.
  ...
  + SCase "type_value_respecting"; repdors; subst;
    ...
    duplicate c1 as ct.
    apply @cequivcn_mkcn_m with (T' := T3) in ct; sp.
  ...
  + SCase "type_mtransitive".
    ...
    generalize (type_family_trans2
                  lib mkcn_m (close lib ts) T3 T T4 eqa eqb eqa0 eqb0 A v B A' v' B');
      intro j.
    ...
    generalize (type_family_trans2
                  lib mkcn_m (close lib ts) T3 T' T4 eqa eqb eqa0 eqb0 A' v' B' A v B); intro j.
