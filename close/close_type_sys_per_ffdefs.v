...
Proof.
  ...
  - SCase "type_value_respecting".
...

    {
      ...
      exists A1 A1 x1 x1 eqa; dands; spcast; auto.
    ...
    {
      eapply ccequivc_ext_ffdefs in ceq;[|eauto]; exrepnd; spcast.
      exists A2 A2 x2 x2 eqa; dands; spcast; auto.
      { eapply in_ext_ext_type_sys_props4_ccequivc_ext_implies; try exact tsa; auto; eauto 3 with slow. }
      { eapply in_ext_type_sys_props4_implies_ceq_change_eq6; try exact tsa; try exact cla; eauto 3 with slow. }
  ...
  - SCase "type_value_respecting_trans1".
    eapply implies_type_value_respecting_trans1_per_ffdefs; eauto.

  - SCase "type_value_respecting_trans2".
    eapply implies_type_value_respecting_trans2_per_ffdefs; eauto.

  - SCase "term_symmetric".
    introv ee.
    apply eqiff in ee; apply eqiff; clear eqiff.
    apply per_ffdefs_eq_bar_symmetric; eauto 3 with slow.

  - SCase "term_transitive".
    introv ee1 ee2.
    apply eqiff in ee1; apply eqiff in ee2; apply eqiff; clear eqiff.
    eapply per_ffdefs_eq_bar_transitive; eauto 3 with slow.

  - SCase "term_value_respecting".
    introv ee ceq.
    apply eqiff in ee; apply eqiff.
    eapply per_ffdefs_eq_bar_cequiv; eauto 3 with slow.
