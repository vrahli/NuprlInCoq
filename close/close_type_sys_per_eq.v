...
Proof.
  ...
  + SCase "uniquely_valued".
    ...
    * SSCase "CL_eq".
      ...
      pose proof (all_in_bar_type_sys_props4_implies_type_equality_respecting_trans (close ts) lib bar bar0 A B A0 B0 eqa eqa0) as q.
  ...
  + SCase "type_value_respecting_trans".
...

    {
      ...
      pose proof (all_in_bar_type_sys_props4_implies_type_equality_respecting_trans (close ts) lib bar bar0 A B A0 B0 eqa eqa0) as h4.
...

    {
      ...
      repeat (autodimp h3 hyp);[].
      apply all_in_bar_ccequivc_implies_all_in_bar_ccequivc_ext in h3.
      pose proof (all_in_bar_type_sys_props4_sym_implies_type_equality_respecting_trans (close ts) lib bar bar0 B A A0 B0 eqa eqa0) as h4.
      repeat (autodimp h4 hyp);[].
...

    {
      ...
      repeat (autodimp h3 hyp);[].
      apply all_in_bar_ccequivc_implies_all_in_bar_ccequivc_ext in h3.
      pose proof (all_in_bar_type_sys_props4_implies_type_equality_respecting_trans3 (close ts) lib bar bar0 A B B0 A0 eqa eqa0) as h4.
      repeat (autodimp h4 hyp);[].
      exists A A0 a1 a2 a0 a3 eqa; dands; auto.

      - exists (intersect_bars bar bar0); dands; eauto 3 with slow.
        { eapply all_in_bar_type_sys_props4_implies_type_equality_respecting_trans4; eauto 3 with slow. }
        { eapply implies_all_in_bar_eqorceq_trans_ccequivc; eauto 3 with slow.
          eapply implies_all_in_bar_eqorceq_sym; eauto 3 with slow. }
        { eapply implies_all_in_bar_eqorceq_trans_ccequivc; eauto 3 with slow.
          eapply implies_all_in_bar_eqorceq_sym; eauto 3 with slow. }
...

    {
      ...
      repeat (autodimp h3 hyp);[].
      apply all_in_bar_ccequivc_implies_all_in_bar_ccequivc_ext in h3.
      pose proof (all_in_bar_type_sys_props4_sym_implies_type_equality_respecting_trans3 (close ts) lib bar bar0 B A B0 A0 eqa eqa0) as h4.
      repeat (autodimp h4 hyp);[].
      exists B A0 b1 b2 a0 a3 eqa; dands; auto.

      - exists (intersect_bars bar bar0); dands; eauto 3 with slow.
        { eapply all_in_bar_type_sys_props4_sym_implies_type_equality_respecting_trans4; eauto 3 with slow. }
        { eapply implies_all_in_bar_eqorceq_trans_ccequivc; eauto 3 with slow.
          eapply implies_all_in_bar_eqorceq_sym; eauto 3 with slow. }
        { eapply implies_all_in_bar_eqorceq_trans_ccequivc; eauto 3 with slow.
          eapply implies_all_in_bar_eqorceq_sym; eauto 3 with slow. }
  ...
  + SCase "type_gsymmetric".
...

    {
      ...
      pose proof (all_in_bar_type_sys_props4_implies_type_equality_respecting_trans (close ts) lib bar bar0 A B A0 B0 eqa eqa0) as w4.
...

    {
      ...
      pose proof (all_in_bar_type_sys_props4_implies_type_equality_respecting_trans3 (close ts) lib bar bar0 A B B0 A0 eqa eqa0) as w4.
      repeat (autodimp w4 hyp);[].
  ...
  + SCase "type_mtransitive".
...

    {
      ...
      pose proof (all_in_bar_type_sys_props4_implies_type_equality_respecting_trans (close ts) lib bar bar1 A B A1 B1 eqa eqa1) as z4.
      repeat (autodimp z4 hyp);[].
      ...
      - exists A0 B1 a0 a3 b4 b5 eqa0; dands; auto.
        ...
        + pose proof (all_in_bar_type_sys_props4_implies_type_equality_respecting_trans2 (close ts) lib bar bar1 A B A1 B1 eqa eqa1) as u1.
          repeat (autodimp u1 hyp).
          pose proof (all_in_bar_type_sys_props4_implies_type_equality_respecting_trans4 (close ts) lib bar bar0 A B B0 A0 eqa eqa0) as u2.
          repeat (autodimp u2 hyp).
          eapply all_in_bar_type_sys_props4_change_eq_term_equals1 in u1; try (exact w4); eauto 3 with slow;[].
          eapply all_in_bar_type_sys_props4_change_eq_term_equals1 in u2; try (exact w4); eauto 3 with slow;[].

          pose proof (all_in_bar_type_sys_props4_trans2 (close ts) lib (intersect3bars bar bar0 bar1) A B A0 B1 eqa eqa0) as q.
          repeat (autodimp q hyp); eauto 3 with slow.

        + eapply all_in_bar_eqorceq_eq_term_equals2;[apply eq_term_equals_sym;eauto|].
          apply (implies_all_in_bar_eqorceq_trans _ _ (close ts) _ _ b0 _ A B); eauto 3 with slow;[].
          apply (implies_all_in_bar_eqorceq_trans_ccequivc _ _ _ a4); eauto 3 with slow;[].
          apply all_in_bar_ccequivc_sym.
          eapply all_in_bar_ccequivc_trans; eauto 3 with slow.

        + eapply all_in_bar_eqorceq_eq_term_equals2;[apply eq_term_equals_sym;eauto|].
          apply (implies_all_in_bar_eqorceq_trans _ _ (close ts) _ _ b3 _ A B); eauto 3 with slow;[].
          apply (implies_all_in_bar_eqorceq_trans_ccequivc _ _ _ a5); eauto 3 with slow;[].
          apply all_in_bar_ccequivc_sym.
          eapply all_in_bar_ccequivc_trans; eauto 3 with slow.
      ...
      - exists A0 B1 a0 a3 b4 b5 eqa0; dands; auto.
        ...
        + eapply eq_term_equals_trans;[eauto|].
          apply (eqorceq_implies_iff_per_eq_eq _ (intersect3bars bar bar0 bar1)); eauto 3 with slow.

          * eapply eq_term_equals_trans;[|eauto].
            apply eq_term_equals_sym; auto.

          * eapply (all_in_bar_eqorceq_eq_term_equals _ _ eqa);
              [eapply eq_term_equals_trans;[|eauto];apply eq_term_equals_sym;auto|].
            apply (implies_all_in_bar_eqorceq_trans_ccequivc _ _ _ b0); eauto 3 with slow.
            { eapply all_in_bar_ccequivc_trans; eauto 3 with slow. }
            { eapply implies_all_in_bar_eqorceq_sym; eauto 3 with slow. }

          * eapply (all_in_bar_eqorceq_eq_term_equals _ _ eqa);
              [eapply eq_term_equals_trans;[|eauto];apply eq_term_equals_sym;auto|].
            apply (implies_all_in_bar_eqorceq_trans_ccequivc _ _ _ b3); eauto 3 with slow.
            { eapply all_in_bar_ccequivc_trans; eauto 3 with slow. }
            { eapply implies_all_in_bar_eqorceq_sym; eauto 3 with slow. }

          * apply (eq_term_equals_preserves_all_in_bar_term_equality_respecting _ _ eqa); eauto 3 with slow.
    }

    {
      ...
      repeat (autodimp w3 hyp);[].
      apply all_in_bar_ccequivc_implies_all_in_bar_ccequivc_ext in w3.
      pose proof (all_in_bar_type_sys_props4_sym_implies_type_equality_respecting_trans3 (close ts) lib bar bar0 B A B0 A0 eqa eqa0) as w4.
      repeat (autodimp w4 hyp);[].
      ...
      repeat (autodimp z3 hyp);[].
      apply all_in_bar_ccequivc_implies_all_in_bar_ccequivc_ext in z3.
      pose proof (all_in_bar_type_sys_props4_sym_implies_type_equality_respecting_trans (close ts) lib bar bar1 B A A1 B1 eqa eqa1) as z4.
      repeat (autodimp z4 hyp);[].
      ...
      - exists A0 B1 a0 a3 b4 b5 eqa0; dands; auto.
        ...
        + pose proof (all_in_bar_type_sys_props4_sym_implies_type_equality_respecting_trans2 (close ts) lib bar bar1 B A A1 B1 eqa eqa1) as u1.
          repeat (autodimp u1 hyp);[].
          pose proof (all_in_bar_type_sys_props4_sym_implies_type_equality_respecting_trans4 (close ts) lib bar bar0 B A B0 A0 eqa eqa0) as u2.
          repeat (autodimp u2 hyp);[].

          eapply all_in_bar_type_sys_props4_sym_change_eq_term_equals1 in u1; try (exact w4); eauto 3 with slow;[].
          eapply all_in_bar_type_sys_props4_sym_change_eq_term_equals1 in u2; try (exact w4); eauto 3 with slow;[].
          pose proof (all_in_bar_type_sys_props4_sym_trans2 (close ts) lib (intersect3bars bar bar0 bar1) B A A0 B1 eqa eqa0) as q.
          repeat (autodimp q hyp); eauto 3 with slow.
