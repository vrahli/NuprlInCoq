...
Require Export close_util_set2.
...
Proof.
  ...
  + SCase "uniquely_valued".
    ...
    eapply per_bar_per_set_implies_eq_term_equals_per_set_eq;
  ...
  + SCase "type_value_respecting".
    introv ee ceq; repndors; subst;
      apply CL_set; exists eqa eqb; dands; auto.
  ...
  + SCase "type_value_respecting_trans1".
    eapply implies_type_value_respecting_trans1_per_set; eauto.

  + SCase "type_value_respecting_trans2".
    eapply implies_type_value_respecting_trans2_per_set; eauto.

  + SCase "term_symmetric".
    introv ee.
    apply eqiff in ee; apply eqiff; clear eqiff.
    eapply per_set_eq_bar_sym; eauto.

  + SCase "term_transitive".
    introv ee1 ee2.
    apply eqiff in ee1; apply eqiff in ee2; apply eqiff; clear eqiff.
    eapply per_set_eq_bar_trans; eauto.

  + SCase "term_value_respecting".
    introv ee ceq.
    apply eqiff in ee; apply eqiff; clear eqiff.
    eapply per_set_eq_bar_resp; eauto.
  ...
  + SCase "type_gsymmetric".
    ...
    split; intro cl; dclose_lr; clear cl; apply per_bar_per_set_implies_close.
    { eapply per_bar_per_set_sym; try exact comp1;eauto. }
    { eapply per_bar_per_set_sym_rev; try exact comp1;eauto. }
  ...
  + SCase "type_mtransitive".
    ...
    repndors; subst; dclose_lr; clear cl1 cl2; dands; apply per_bar_per_set_implies_close.

    { eapply per_bar_per_set_trans1; try exact comp1; try exact h; try exact h0; eauto. }
    { eapply per_bar_per_set_trans2; try exact comp1; try exact h; try exact h0; eauto. }
    { eapply per_bar_per_set_trans3; try exact comp2; try exact h; try exact h0; eauto. }
    { eapply per_bar_per_set_trans4; try exact comp2; try exact h; try exact h0; eauto. }
Qed.
