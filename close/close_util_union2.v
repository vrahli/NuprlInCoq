...
Lemma per_bar_per_union_implies_eq_term_equals_per_union_eq_bar {o} :
  forall inh (ts : cts(o)) lib T T' eq (eqa eqb : lib-per(inh,lib,o)) A B A' B',
    ccomputes_to_valc_ext inh lib T (mkc_union A B)
...
Proof.
  ...
  - unfold per_union_eq_bar, per_union_eq.
    ...
    dup per4 as eqbs.
    eapply (in_ext_ext_type_sys_props4_ccequivc_ext_implies_in_ext_ext_eq_term_equals4 _ _ e) in eqbs;
    ...
    { eapply (lib_per_cond _ _ eqa); apply (eqas _ e0); auto. }

    { eapply (lib_per_cond _ _ eqb); apply (eqbs _ e0); auto. }
  ...
  - eapply in_open_bar_ext_comb; try exact per1; clear per1.
    ...
    apply (sub_per_per_union_eq_bar _ _ _ e) in h.
...
Lemma type_value_respecting_trans_per_bar_per_union1 {o} :
  forall inh lib (ts : cts(o)) T T1 T2 A B A' B' C D (eqa eqb : lib-per(inh,lib,o)) eq,
    in_ext_ext inh lib (fun lib' x => type_sys_props4 inh ts lib' A C (eqa lib' x))
    -> in_ext_ext inh lib (fun lib' x => type_sys_props4 inh ts lib' B D (eqb lib' x))
    -> ccomputes_to_valc_ext inh lib T1 (mkc_union A' B')
    -> ccomputes_to_valc_ext inh lib T (mkc_union A B)
    -> ccequivc_ext inh lib A A'
    -> ccequivc_ext inh lib B B'
    -> per_bar inh (per_union inh ts) lib T1 T2 eq
    -> per_bar inh (per_union inh ts) lib T T2 eq.
Proof.
  ...
  apply (implies_in_ext_ext_ts_raise_lib_per _ _ _ _ e) in tsb.
...
Lemma type_value_respecting_trans_per_bar_per_union2 {o} :
  forall inh lib (ts : cts(o)) T T1 T2 A B A' B' C D (eqa eqb : lib-per(inh,lib,o)) eq,
    ...
    -> ccequivc_ext inh lib A A'
    -> ccequivc_ext inh lib B B'
    -> per_bar inh (per_union inh ts) lib T2 T1 eq
    -> per_bar inh (per_union inh ts) lib T T2 eq.
Proof.
  introv tsa tsb comp1 comp2 ceqa ceqb per.
  unfold per_bar in *; exrepnd.
...
Lemma per_union_sym {o} :
  forall inh ts lib (T1 T2 : @CTerm o) A A' B B' equ (eqa eqb : lib-per(inh,lib,o)),
    ccomputes_to_valc_ext inh lib T1 (mkc_union A B)
    -> in_ext_ext inh lib (fun lib' x => type_sys_props4 inh ts lib' A A' (eqa lib' x))
    -> in_ext_ext inh lib (fun lib' x => type_sys_props4 inh ts lib' B B' (eqb lib' x))
    -> per_union inh ts lib T1 T2 equ
    -> per_union inh ts lib T2 T1 equ.
Proof.
...
Lemma per_bar_per_union_sym {o} :
  forall inh (ts : cts(o)) lib T T' A B A' B' (eqa eqb : lib-per(inh,lib,o)) eq,
    in_ext_ext inh lib (fun lib' x => type_sys_props4 inh ts lib' A A' (eqa lib' x))
    -> in_ext_ext inh lib (fun lib' x => type_sys_props4 inh ts lib' B B' (eqb lib' x))
    -> ccomputes_to_valc_ext inh lib T (mkc_union A B)
    -> per_bar inh (per_union inh ts) lib T T' eq
...
Lemma per_union_trans1 {o} :
  forall inh ts lib (T T1 T2 : @CTerm o) eq1 eq2 (eqa eqb : lib-per(inh,lib,o)) A B A' B',
    ccomputes_to_valc_ext inh lib T (mkc_union A B)
    -> in_ext_ext inh lib (fun lib' x => type_sys_props4 inh ts lib' A A' (eqa lib' x))
    -> in_ext_ext inh lib (fun lib' x => type_sys_props4 inh ts lib' B B' (eqb lib' x))
    -> per_union inh ts lib T T2 eq2
    -> per_union inh ts lib T1 T eq1
    -> per_union inh ts lib T1 T2 eq1.
Proof.
...
Lemma per_union_trans2 {o} :
  forall inh ts lib (T T1 T2 : @CTerm o) eq1 eq2 (eqa eqb : lib-per(inh,lib,o)) A B A' B',
    ...
    -> per_union inh ts lib T T2 eq2
    -> per_union inh ts lib T1 T eq1
    -> per_union inh ts lib T1 T2 eq2.
Proof.
  introv comp tsa tsb pera perb.
  unfold per_union in *; exrepnd.
...
Lemma per_bar_per_union_trans1 {o} :
  forall inh (ts : cts(o)) lib T T1 T2 A B A' B' (eqa eqb : lib-per(inh,lib,o)) eq1 eq2,
    in_ext_ext inh lib (fun lib' x => type_sys_props4 inh ts lib' A A' (eqa lib' x))
    -> in_ext_ext inh lib (fun lib' x => type_sys_props4 inh ts lib' B B' (eqb lib' x))
    -> ccomputes_to_valc_ext inh lib T (mkc_union A B)
    -> per_bar inh (per_union inh ts) lib T1 T eq1
    -> per_bar inh (per_union inh ts) lib T T2 eq2
    -> per_bar inh (per_union inh ts) lib T1 T2 eq1.
Proof.
...
Lemma per_bar_per_union_trans2 {o} :
  forall inh (ts : cts(o)) lib T T1 T2 A B A' B' (eqa eqb : lib-per(inh,lib,o)) eq1 eq2,
    ...
    -> per_bar inh (per_union inh ts) lib T1 T eq1
    -> per_bar inh (per_union inh ts) lib T T2 eq2
    -> per_bar inh (per_union inh ts) lib T1 T2 eq2.
Proof.
  introv tsa tsb comp pera perb.
  unfold per_bar in *; exrepnd.
  exists eqa0; dands; auto.
...
Lemma implies_type_value_respecting_trans1_per_union {o} :
  forall inh ts lib T T' eq A1 A2 B1 B2 (eqa eqb : lib-per(inh,lib,o)),
    type_system inh ts
    -> defines_only_universes inh ts
    -> T ===>(inh,lib) (mkc_union A1 B1)
    -> T' ===>(inh,lib) (mkc_union A2 B2)
    -> in_ext_ext inh lib (fun lib' x => close inh ts lib' A1 A2 (eqa lib' x))
    -> in_ext_ext inh lib (fun lib' x => type_sys_props4 inh (close inh ts) lib' A1 A2 (eqa lib' x))
    -> in_ext_ext inh lib (fun lib' x => close inh ts lib' B1 B2 (eqb lib' x))
    -> in_ext_ext inh lib (fun lib' x => type_sys_props4 inh (close inh ts) lib' B1 B2 (eqb lib' x))
    -> (eq <=2=> (per_union_eq_bar inh lib eqa eqb))
...
Lemma type_value_respecting_trans_per_bar_per_union3 {o} :
  forall inh lib (ts : cts(o)) T T1 T2 A B A' B' (eqa eqb : lib-per(inh,lib,o)) eq,
    in_ext_ext inh lib (fun lib' x => type_sys_props4 inh ts lib' A A' (eqa lib' x))
    -> in_ext_ext inh lib (fun lib' x => type_sys_props4 inh ts lib' B B' (eqb lib' x))
    -> ccomputes_to_valc_ext inh lib T (mkc_union A B)
    -> ccequivc_ext inh lib T1 T2
    -> per_bar inh (per_union inh ts) lib T T1 eq
    -> per_bar inh (per_union inh ts) lib T T2 eq.
Proof.
