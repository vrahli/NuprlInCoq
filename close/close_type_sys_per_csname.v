...
Proof.
  ...
  + SCase "type_symmetric"; repdors; subst; dclose_lr;
      ...
      apply per_csname_implies_per_csname_bar in per.
  ...
  + SCase "type_value_respecting"; repndors; subst;
      ...
      assert (type_value_respecting (per_csname_bar (close ts)))
        as tvr by (apply per_csname_bar_type_value_respecting).
  ...
  + SCase "type_gsymmetric"; repdors; subst; split; sp; dclose_lr.
    ...
    { apply per_csname_bar_implies_close; allunfold @per_csname_bar; sp.
  ...
  + SCase "type_mtransitive"; repdors; subst; dclose_lr;
      dands; apply per_csname_bar_implies_close; allunfold @per_csname_bar; sp;
