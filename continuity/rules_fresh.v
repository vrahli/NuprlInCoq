...
Definition rule_fresh_member {o}
  ...
  mk_rule
    ...
    [ mk_baresequent
        (snoc (snoc H (mk_hyp a mk_uatom)) (mk_hyp z (mk_efree_from_atom mk_base (mk_fresh v t) (mk_var a))))
        (mk_conclax (mk_member (subst t v (mk_var a)) T)),
      mk_baresequent
        (snoc (snoc H (mk_hyp a mk_uatom)) (mk_hyp z (mk_efree_from_atom mk_base (mk_fresh v t) (mk_var a))))
        (mk_conclax (mk_efree_from_atom mk_base (subst t v (mk_var a)) (mk_var a))),
...
Proof.
  ...
  pose proof (hyp3 s1 s2 eqh sim) as hb; exrepnd.
  lsubst_tac.
  allrw <- @member_member_iff.
  apply tequality_mkc_member_base in hb0; spcast.
  ...
  - vr_seq_true in hyp1.
    ...
    + apply hyps_functionality_snoc2; simpl; auto.
      ...
      * introv equ' sim'.
        lsubst_tac.
        apply tequality_efree_from_atom; dands; eauto 3 with slow.
