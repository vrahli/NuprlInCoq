...
Lemma zero_in_int {o} :
  forall (lib : @library o), member lib mkc_zero mkc_int.
Proof.
  introv.
  rewrite mkc_zero_eq.
  apply nat_in_int.
Qed.
Hint Resolve zero_in_int : slow.

Lemma inhabited_type_mkc_int {o} :
  forall  (lib : @library o), inhabited_type lib mkc_int.
Proof.
  introv.
  exists (@mkc_zero o).
  eauto 3 with slow.
Qed.
Hint Resolve inhabited_type_mkc_int : slow.
  ...
  - apply tequality_mkc_squash.
    ...
    { unfold agree_upto_b_type_v2.
      ...
      - introv e3.
        ...
        apply tequality_fun in k2; repnd.
        ...
        { revert k0.
          ...
          clear - k1 e4 k.
          autodimp k hyp; lsubst_tac; auto.
        ...
        autodimp inh hyp.
        {
...

          {
            ...
            try (complete (apply computes_to_valc_absolute_value; auto;
                           apply computes_to_valc_iff_reduces_toc; eauto with slow)).
            destruct i0; allsimpl; try lia; apply Pos2Z.is_nonneg.
          }

          {
            ...
            try (complete (apply computes_to_valc_absolute_value; auto;
                           apply computes_to_valc_iff_reduces_toc; eauto with slow)).
            revert l; intro l.
            destruct i0; allsimpl; try lia; rw <- Znat.positive_nat_Z; apply Znat.inj_lt; auto.
          }
        }
