...
Proof.
  induction nt as [v| op bts Hind] using NTerm_better_ind; intros Hwf;
...
Proof.
  ...
  - clear ce; allunfold @close_compute_val;
    ...
    inversion aeq0 as [| ? ? ? leq aeqbt]; subst; eauto 3 with slow.
...
Proof.
  ...
  nterm_ind t as [z|op bs ind] Case; auto.
