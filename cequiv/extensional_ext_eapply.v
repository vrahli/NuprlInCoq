...
Lemma extensional_ext_eapply {p} : extensional_op_ext (@NCan p NEApply).
Proof.
    ...
    { csunf XX1; allsimpl.
      ...
      { apply howe_lemma2 in q; exrepnd; auto.
        ...
        - applydup @howe_lemma2_implies_iscan in Has1bt; auto; exrepnd.
          ...
          eapply approx_ext_star_open_trans in Has1bt;
            [|apply approx_ext_implies_approx_ext_open;
               apply computes_to_value_implies_approx_ext2;[|exact Has1bt2];
               auto].
          ...
          eapply approx_ext_star_open_trans;[exact z|].
          apply approx_ext_implies_approx_ext_open.
        ...
        - fold_terms.
          ...
          + apply no_change_after_val_like with (k2:=k) in XX2; eauto 2 with slow; try omega;[].
            ...
            eapply approx_ext_star_open_trans in z;
              [|apply approx_ext_implies_approx_ext_open;
                 apply computes_to_value_implies_approx_ext2;[|exact z2];
                 auto];[].

            apply apply_bterm_approx_ext_star_congr
            ...
            eapply approx_ext_star_open_trans;[exact w|].
            apply approx_ext_implies_approx_ext_open.
            apply reduces_to_implies_approx_ext_eauto; prove_isprogram.
            apply eapply_red_lam_val_implies; simpl; auto.
      ...
      { fold_terms.
        apply approx_ext_star_nseq in q; auto;[].

        repndors; exrepnd; subst; ginv.

        - eapply compute_step_eapply2_success in XX1; repnd; GC.
          repndors; exrepnd; ginv;[].
          apply approx_ext_star_nat in Has1bt; auto;[].
          apply reduces_in_atmost_k_steps_if_isvalue_like in XX0; eauto 2 with slow; subst.
          apply approx_ext_open_implies_approx_ext_star.
          apply approx_ext_implies_approx_ext_open.
          apply reduces_to_implies_approx_ext1;[apply isprogram_eapply;eauto 2 with slow|].
        ...
        - fold_terms.
          ...
          + applydup @preserve_compute_step in XX1; auto.
            ...
            repeat (autodimp z hyp); eauto 2 with slow;[].
            apply approx_ext_star_nat in z; eauto 2 with slow;[].
      ...
      { fold_terms.
        apply approx_ext_star_choice_seq in q; auto;[].
        ...
        - eapply compute_step_eapply2_success in XX1; repnd; GC.
          ...
          assert (approx_ext_star lib a (CSVal2term v)) as apr;
            [|eapply approx_ext_star_open_trans;[exact apr|clear apr];
              apply approx_ext_implies_approx_ext_open;
              apply reduces_to_implies_approx_ext_eauto; prove_isprogram;
              eauto 2 with slow].

          apply approx_ext_open_implies_approx_ext_star.
          apply reduces_to_implies_approx_ext_open1; eauto 2 with slow.
        ...
        - apply isexc_implies in XX2; auto; exrepnd; subst.
          ...
          apply approx_ext_implies_approx_ext_open.
          apply computes_to_exception_implies_approx_ext; auto; prove_isprogram; eauto 2 with slow.
        ...
        - fold_terms.
          ...
          + applydup @preserve_compute_step in XX1; auto.
            ...
            assert (approx_ext_star lib a (CSVal2term val)) as apr;
              [|eapply approx_ext_star_open_trans;[exact apr|clear apr];
                apply approx_ext_implies_approx_ext_open;
                apply reduces_to_implies_approx_ext_eauto; prove_isprogram;
                eauto 2 with slow].
