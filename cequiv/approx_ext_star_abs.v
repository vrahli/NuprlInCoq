...
Definition approx_ext_star_sk {o} lib op (sk1 sk2 : @sosub_kind o) :=
  approx_ext_star_bterm lib op (sk2bterm sk1) (sk2bterm sk2).

Lemma approx_ext_star_sk_if_approx_ext_star_sosub_find {o} :
  forall lib op (vs : list NVar) (sks1 sks2 : list (@sosub_kind o)) (sk1 sk2 : sosub_kind) (sv : sovar_sig),
    ...
    -> bin_rel_sk (approx_ext_star_sk lib op) sks1 sks2
    -> sosub_find (combine vs sks1) sv = Some sk1
    -> sosub_find (combine vs sks2) sv = Some sk2
    -> approx_ext_star_sk lib op sk1 sk2.
Proof.
  ...
  - provefalse.
    unfold approx_ext_star_sk in aeq; simpl in aeq.
...
Lemma approx_ext_star_sk_is_approx_ext_star_bterm {o} :
  forall lib op (b1 b2 : @BTerm o),
    approx_ext_star_bterm lib op b1 b2
    <=> approx_ext_star_sk lib op (bterm2sk b1) (bterm2sk b2).
Proof.
  introv.
  unfold approx_ext_star_sk; simpl.
  destruct b1, b2; simpl; sp.
Qed.

Lemma false_if_approx_ext_star_sk_sosub_find {o} :
...
Lemma false_if_approx_ext_star_sk_sosub_find2 {o} :
  forall lib op (vs : list NVar) (sks1 sks2 : list (@sosub_kind o)) (sk : sosub_kind) (sv : sovar_sig),
    length vs = length sks1
    -> length vs = length sks2
    -> bin_rel_sk (approx_ext_star_sk lib op) sks1 sks2
...
Lemma approx_ext_star_apply_list {o} :
  forall lib ts1 ts2 (t1 t2 : @NTerm o),
    approx_ext_star lib t1 t2
    -> bin_rel_nterm (approx_ext_star lib) ts1 ts2
    -> approx_ext_star lib (apply_list t1 ts1) (apply_list t2 ts2).
Proof.
  ...
  - apply binrel_list_cons in brel; repnd.
    apply IHts1; auto.
    apply approx_ext_star_congruence; auto.
...
Lemma sosub_filter_if_approx_ext_star_sk {o} :
...
(*
Lemma sosub_aux_approx_ext_star_congr {p} :
  forall lib opr (t : @SOTerm p) (vs : list NVar) (ts1 ts2 : list sosub_kind),
    ...
    -> bin_rel_sk (approx_ext_star_sk lib opr) ts1 ts2
    -> approx_ext_star lib (sosub_aux sub1 t) (sosub_aux sub2 t).
Proof.
  ...
  - Case "sovar".
    ...
    + pose proof (apply_bterm_approx_ext_star_congr
      ...
      * apply approx_ext_star_sk_is_approx_ext_star_bterm; simpl.
        eapply approx_ext_star_sk_if_approx_ext_star_sosub_find;
    ...
    + eapply false_if_approx_ext_star_sk_sosub_find in Heqo; eauto; sp.

    + eapply false_if_approx_ext_star_sk_sosub_find2 in Heqo; eauto; sp.

    + apply approx_ext_star_apply_list; auto.

      * apply approx_ext_star_refl; auto.
  ...
  - Case "soterm".
    ...
    apply approx_ext_star_congruence;
      [|rw map_map; unfold compose; rw <- wf0;
        apply eq_maps; introv k; destruct x;
        unfold num_bvars; simpl; auto].

    unfold approx_ext_starbts, lblift; allrw map_length; dands; auto.
    introv i.
    unfold selectbt.
    ...
    pose proof (sosub_filter_if_approx_ext_star_sk lib vs ts1 ts2 (vars2sovars l)) as h.
...
Definition approx_ext_star_sosub {o} lib op (sub1 sub2 : @SOSub o) :=
  bin_rel_sk (approx_ext_star_sk lib op) (so_range sub1) (so_range sub2).

Lemma approx_ext_star_sosub_implies_same_length {o} :
  forall lib op (sub1 sub2 : @SOSub o),
    approx_ext_star_sosub lib op sub1 sub2 -> length sub1 = length sub2.
Proof.
  introv ap.
  unfold approx_ext_star_sosub, bin_rel_sk, binrel_list in ap; repnd.
  allrw @length_so_range; auto.
Qed.

(*
Lemma sosub_aux_approx_ext_star_congr2 {o} :
  forall lib (t : @SOTerm o) (sub1 sub2 : @SOSub o),
    ...
    -> cover_so_vars t sub1
    -> cover_so_vars t sub2
    -> approx_ext_star_sosub lib sub1 sub2
    -> approx_ext_star lib (sosub_aux sub1 t) (sosub_aux sub2 t).
Proof.
  introv wf e disj1 disj2 disj3 disj4 cov1 cov2 ap.
  pose proof (sosub_aux_approx_ext_star_congr
                lib t
...
Lemma approx_ext_star_sk_if_approx_ext_star_sosub_find2 {o} :
  forall lib op (sub1 sub2 : @SOSub o) (sk1 sk2 : sosub_kind) (sv : sovar_sig),
    so_dom sub1 = so_dom sub2
    -> approx_ext_star_sosub lib op sub1 sub2
    -> sosub_find sub1 sv = Some sk1
    -> sosub_find sub2 sv = Some sk2
    -> approx_ext_star_sk lib op sk1 sk2.
Proof.
  introv e ap f1 f2.
  applydup @approx_ext_star_sosub_implies_same_length in ap.
  apply (approx_ext_star_sk_if_approx_ext_star_sosub_find
...
Lemma false_if_approx_ext_star_sosub_find {o} :
...
Proof.
  introv e ap f1 f2.
  pose proof (false_if_approx_ext_star_sk_sosub_find
...
Lemma false_if_approx_ext_star_sosub_find2 {o} :
  forall lib op (sub1 sub2 : @SOSub o) (sk : sosub_kind) (sv : sovar_sig),
    so_dom sub1 = so_dom sub2
    -> approx_ext_star_sosub lib op sub1 sub2
...
Proof.
  introv e ap f1 f2.
  pose proof (false_if_approx_ext_star_sk_sosub_find2
                lib op (so_dom sub1) (so_range sub1) (so_range sub2)
                sk sv) as h.
  allrw @length_so_dom.
  allrw @length_so_range.
...
(*
Lemma approx_ext_star_sk_trans {o} :
  forall lib (sk1 sk2 sk3 : @sosub_kind o),
    approx_ext_star_sk lib sk1 sk2
    -> approx_ext_star_sk lib sk2 sk3
    -> approx_ext_star_sk lib sk1 sk3.
Proof.
  introv ap1 ap2.
  allunfold @approx_ext_star_sk.
...
Lemma approx_ext_star_sosub_cons {o} :
  forall lib op v1 v2 sk1 sk2 (sub1 sub2 : @SOSub o),
    approx_ext_star_sosub lib op ((v1,sk1) :: sub1) ((v2,sk2) :: sub2)
    <=> (approx_ext_star_sk lib op sk1 sk2 # approx_ext_star_sosub lib op sub1 sub2).
Proof.
  introv.
  unfold approx_ext_star_sosub, bin_rel_sk, binrel_list; simpl.
  allrw @length_so_range.
...
Lemma approx_ext_star_sk_alphaeq_l {o} :
  forall lib op (sk1 sk2 sk3 : @sosub_kind o),
    approx_ext_star_sk lib op sk1 sk2
    -> alphaeq_sk sk2 sk3
    -> approx_ext_star_sk lib op sk1 sk3.
Proof.
  introv ap aeq.
  allunfold @approx_ext_star_sk.
...
Lemma approx_ext_star_sk_alphaeq_r {o} :
  forall lib op (sk1 sk2 sk3 : @sosub_kind o),
    alphaeq_sk sk1 sk2
    -> approx_ext_star_sk lib op sk2 sk3
    -> approx_ext_star_sk lib op sk1 sk3.
Proof.
  introv aeq ap.
  allunfold @approx_ext_star_sk.
  ...
  allrw @alphaeqbt_eq.
  destruct sk1 as [l1 t1], sk2 as [l2 t2], sk3 as [l3 t3]; allsimpl.
  eapply approx_ext_star_bterm_alpha_fun_l; eauto.
Qed.

Lemma approx_ext_star_sosub_alphaeq_l {o} :
  forall lib op (sub1 sub2 sub3 : @SOSub o),
    approx_ext_star_sosub lib op sub1 sub2
    -> alphaeq_sosub sub2 sub3
    -> approx_ext_star_sosub lib op sub1 sub3.
Proof.
  ...
  apply @approx_ext_star_sosub_cons in ap; repnd.
  apply @approx_ext_star_sosub_cons.

  dands.

  - eapply approx_ext_star_sk_alphaeq_l; eauto.

  - eapply IHsub1; eauto.
Qed.

Lemma approx_ext_star_sosub_alphaeq_r {o} :
  forall lib op (sub1 sub2 sub3 : @SOSub o),
    alphaeq_sosub sub1 sub2
    -> approx_ext_star_sosub lib op sub2 sub3
    -> approx_ext_star_sosub lib op sub1 sub3.
Proof.
  ...
  inversion aeq; subst; clear aeq.
  allapply @approx_ext_star_sosub_cons; repnd.
  apply @approx_ext_star_sosub_cons; repnd.

  dands.

  - eapply approx_ext_star_sk_alphaeq_r; eauto.
...
Lemma approx_ext_starbts_implies_approx_ext_star_sosub {o} :
  forall lib op (bs1 bs2 : list (@BTerm o)) vars,
    approx_ext_starbts lib op bs1 bs2
    -> approx_ext_star_sosub lib op (mk_abs_subst vars bs1) (mk_abs_subst vars bs2).
Proof.
  induction bs1; destruct bs2; destruct vars; introv ap; allsimpl; auto;
  try (complete (inversion ap; allsimpl; cpx)).
  - unfold approx_ext_star_sosub, bin_rel_sk, binrel_list; simpl; sp.
  - destruct s; unfold approx_ext_star_sosub, bin_rel_sk, binrel_list; simpl; sp.
  - unfold approx_ext_star_sosub, bin_rel_sk, binrel_list; simpl; sp.
  - rw @approx_ext_starbts_cons in ap; repnd.
    destruct s; destruct a, b; simpl; boolvar; simpl; tcsp.
    + apply approx_ext_star_sosub_cons; dands; auto.
...
Lemma sosub_aux_approx_ext_star_congr_al {p} :
  forall lib (t1 t2 : @SOTerm p) (sub1 sub2 : SOSub) opr,
    ...
    -> opr <> NCan NFresh
    -> approx_ext_star_sosub lib opr sub1 sub2
    -> approx_ext_star lib (sosub_aux sub1 t1) (sosub_aux sub2 t2).
Proof.
  ...
  - Case "sovar".
    ...
    + pose proof (apply_bterm_approx_ext_star_congr
      ...
      * apply approx_ext_star_sk_is_approx_ext_star_bterm; simpl.
        rw <- len in Heqq.
        eapply approx_ext_star_sk_if_approx_ext_star_sosub_find2;
    ...
    + rw len in Heqo.
      eapply false_if_approx_ext_star_sosub_find in Heqo; eauto; sp.

    + rw len in Heqo.
      eapply false_if_approx_ext_star_sosub_find2 in Heqo; eauto; sp.
  ...
  - Case "soseq".
    ...
    eapply apss; try (apply approx_ext_open_refl); eauto 3 with slow.
    introv.
    apply alpha_implies_approx_ext_star; eauto 3 with slow.
  ...
  - Case "soterm".
    ...
    apply approx_ext_starbts_map; auto.
    introv i.
...
Lemma sosub_approx_ext_star_congr {p} :
  forall (lib : library)
         (opr : Opid)
         (t : @SOTerm p)
         (sub1 sub2 : SOSub),
    ...
    -> opr <> NCan NFresh
    -> approx_ext_star_sosub lib opr sub1 sub2
    -> approx_ext_star lib (sosub sub1 t) (sosub sub2 t).
Proof.
  ...
  eapply sosub_aux_approx_ext_star_congr_al; eauto 3 with slow.
  ...
  - eapply approx_ext_star_sosub_alphaeq_r;[apply alphaeq_sosub_sym;exact h0|].
    eapply approx_ext_star_sosub_alphaeq_l;[|exact k0];auto.
Qed.

Lemma mk_instance_approx_ext_star_congr {p} :
  forall (lib : library)
         (opr : @Opid p)
         (t : @SOTerm p)
         (vars : list sovar_sig)
    ...
    -> opr <> NCan NFresh
    -> approx_ext_starbts lib opr bs1 bs2
    -> approx_ext_star lib (mk_instance vars bs1 t) (mk_instance vars bs2 t).
Proof.
  introv wf cov m1 m2 d ap.
  unfold mk_instance.
  eapply sosub_approx_ext_star_congr; eauto.
  ...
  - apply approx_ext_starbts_implies_approx_ext_star_sosub; auto.
Qed.
