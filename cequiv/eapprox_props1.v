...
Proof.
  ...
  - clear cl2 cl cl4.
    introv comp.
    eapply compute_to_exception_alpha in comp;[| |eauto]; eauto 3 with slow; exrepnd.
    applydup @preserve_program_exc2 in comp0; auto; repnd.
    apply cl3 in comp0.
    repndors; tcsp.

    {
      left.
      eapply compute_to_same_name_respects_alpha_l;[| |exact comp0]; eauto 3 with slow.
    }

    exrepnd.
    right.
    eexists; eexists; dands;[eauto| |]; eauto 2 with slow.
...
Lemma ex_approx_change_utoks {o} :
  forall lib ex (t1 t2 : @NTerm o) ren,
    ...
    -> ex_approx lib ex (ren_utokens ren t1) (ren_utokens ren t2).
Proof.
  introv nr1 nr2 d1 d2 apr.
  allrw @ex_approx_ex_sqle.
  allunfold @ex_sqle.
  intro m.
  ...
  allunfold @ex_close_comput; repnd; dands; tcsp; eauto with slow; introv comp.
  ...
  - clear cl2 cl cl4.
    ...
    dup comp1 as comp2.
    apply cl3 in comp2; repndors; exrepnd; tcsp.
