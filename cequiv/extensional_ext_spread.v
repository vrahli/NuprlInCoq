...
Lemma extensional_ext_spread {p} : extensional_op_ext (@NCan p NSpread).
Proof.
  ...
  - apply iscan_implies in Hcv0; repndors; exrepnd; subst;
    ...
    unfold approx_ext_starbts, lblift_sub in h1; simpl in h1; repnd.
    ...
    apply approx_ext_star_open_trans with (b := lsubst b0 [(v0, a0r), (v3, b1r)]); auto.
