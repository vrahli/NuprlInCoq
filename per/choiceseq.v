...
Proof.
  ...
  { apply cor; try omega.
    apply natSeq2restrictionPred_iff_is_nat in sat; auto; try omega. }
Qed.*)
...
Proof.
...

  {
    ...
    - rewrite select_app_r in j; try omega.
      ...
      { rewrite select_follow_law in j; auto; try omega; inversion j; subst; tcsp. }
...
Proof.
  ...
  { exists pos; dands; tcsp; try omega. }
