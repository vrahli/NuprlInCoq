...
Lemma all_in_bar_ext_equal_equality_of_atom_bar_implies_per_bar_eq_implies_equality_of_atom_bar {o} :
  forall lib (bar : @BarLib o lib) (eqa : lib-per(lib,o)),
    all_in_bar_ext bar (fun lib' x => (eqa lib' x) <=2=> (equality_of_atom_bar lib'))
...
Qed.
Hint Resolve all_in_bar_ext_equal_equality_of_atom_bar_implies_per_bar_eq_implies_equality_of_atom_bar : slow.

Lemma local_per_atom_bar {o} :
  forall {lib} (bar : @BarLib o lib) ts T T' eq eqa,
    (eq <=2=> (per_bar_eq bar eqa))
    -> all_in_bar_ext bar (fun lib' x => per_atom_bar ts lib' T T' (eqa lib' x))
...
Proof.
  ...
  {
    apply all_in_bar_ext_equal_equality_of_atom_bar_implies_per_bar_eq_implies_equality_of_atom_bar in alla; apply alla; auto.
  }

  {
    introv br ext; introv.
    eapply alla; eauto.
    eapply sub_per_equality_of_atom_bar; eauto.
  }
Qed.
