...
Lemma bar_and_fam_per2lib_per_implies_lpaf_eqa {o} :
  forall {lib lib' : SL} {bar : @BarLib o lib} {feqa : bar-and-fam-per(lib,bar,o)}
         {A v B C w D}
         (F : forall (lib1 : SL) (br : bar_lib_bar bar lib1) (lib2 : SL) (ext : lib_extends lib2 lib1) (x : lib_extends lib2 lib), type_family_ext mkc_product nuprl lib2 (mkc_product A v B) (mkc_product C w D) (lpaf_eqa (feqa lib1 br lib2 ext x)) (lpaf_eqb (feqa lib1 br lib2 ext x)))
...
Proof.
  ...
  assert (forall (lib1 : SL) (br : bar_lib_bar bar lib1) (lib2 : SL) (ext : lib_extends lib2 lib1) (x : lib_extends lib2 lib), type_family_ext mkc_product nuprl lib2 (mkc_product A v B) (mkc_product C w D) (lpaf_eqa (feqa lib1 br lib2 ext x)) (lpaf_eqb (feqa lib1 br lib2 ext x))) as F by eapply u2.
...

  {
...

    {
      ...
      - exists lib' br (lib_extends_trans e ext) (lib_extends_trans e x).
        ...
        repeat ccomputes_to_valc_ext_val.
        eapply in_ext_ext_nuprl_value_respecting_left  in u3;[|apply ccequivc_ext_sym;eauto].
        eapply in_ext_ext_nuprl_value_respecting_right in u3;[|apply ccequivc_ext_sym;eauto].
        eapply in_ext_ext_fam_nuprl_value_respecting_left  in u0;[|apply bcequivc_ext_sym;eauto].
        eapply in_ext_ext_fam_nuprl_value_respecting_right in u0;[|apply bcequivc_ext_sym;eauto].
        ...
        repeat ccomputes_to_valc_ext_val.
        eapply in_ext_ext_nuprl_value_respecting_left  in q3;[|apply ccequivc_ext_sym;eauto].
        eapply in_ext_ext_nuprl_value_respecting_right in q3;[|apply ccequivc_ext_sym;eauto].
        eapply in_ext_ext_fam_nuprl_value_respecting_left  in q1;[|apply bcequivc_ext_sym;eauto].
        eapply in_ext_ext_fam_nuprl_value_respecting_right in q1;[|apply bcequivc_ext_sym;eauto].
...

  {
    ...
    repeat ccomputes_to_valc_ext_val.
    eapply in_ext_ext_nuprl_value_respecting_left  in h3;[|apply ccequivc_ext_sym;eauto].
    eapply in_ext_ext_nuprl_value_respecting_right in h3;[|apply ccequivc_ext_sym;eauto].
    eapply in_ext_ext_fam_nuprl_value_respecting_left  in h0;[|apply bcequivc_ext_sym;eauto].
    eapply in_ext_ext_fam_nuprl_value_respecting_right in h0;[|apply bcequivc_ext_sym;eauto].
...
Lemma bar_and_fam_per2lib_per_implies_lpaf_eqa_i {o} :
  forall {lib lib' : SL} {bar : @BarLib o lib} {feqa : bar-and-fam-per(lib,bar,o)}
         {A v B C w D i}
         (F : forall (lib1 : SL) (br : bar_lib_bar bar lib1) (lib2 : SL) (ext : lib_extends lib2 lib1) (x : lib_extends lib2 lib), type_family_ext mkc_product (nuprli i) lib2 (mkc_product A v B) (mkc_product C w D) (lpaf_eqa (feqa lib1 br lib2 ext x)) (lpaf_eqb (feqa lib1 br lib2 ext x)))
         {x : lib_extends lib' lib}
         {a a'}
         (lib1 : SL)
         (br : bar_lib_bar bar lib1)
...
Proof.
  ...
  assert (forall (lib1 : SL) (br : bar_lib_bar bar lib1) (lib2 : SL) (ext : lib_extends lib2 lib1) (x : lib_extends lib2 lib), type_family_ext mkc_product (nuprli i) lib2 (mkc_product A v B) (mkc_product C w D) (lpaf_eqa (feqa lib1 br lib2 ext x)) (lpaf_eqb (feqa lib1 br lib2 ext x))) as F by eapply u2.
...

  {
...

    {
      ...
      - exists lib' br (lib_extends_trans e ext) (lib_extends_trans e x).
        ...
        repeat ccomputes_to_valc_ext_val.
        eapply in_ext_ext_nuprli_value_respecting_left  in u3;[|apply ccequivc_ext_sym;eauto].
        eapply in_ext_ext_nuprli_value_respecting_right in u3;[|apply ccequivc_ext_sym;eauto].
