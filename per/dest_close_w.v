...
Proof.
...

  {
    ...
    apply per_bar_eq_weq_bar_lib_per.
  }
Qed.
Hint Resolve per_w_bar_implies_per_bar : slow.

Lemma weq_bar_change_pers {o} :
  forall ts uk (lib lib0 : @library o) A A' v B v' B' A1 A2 A3 A4 v1 B1 v2 B2 v3 B3 v4 B4
    ...
    -> weq_bar lib0 eqa2 eqb2 t1 t2
    -> weq_bar lib0 eqa1 eqb1 t1 t2.
Proof.
  introv ext ceqa ceqb ceqc ceqd ceqe ceqf.
  introv tya tyb tsa tsb tsc tsd per.

  eapply implies_eq_term_equals_weq_bar;[| |eauto].
...
Lemma weq_bar_change_pers2 {o} :
  forall ts uk (lib lib0 : @library o) T T' A A' v v' B B'
    ...
    -> in_ext_ext lib (fun lib' x => type_sys_props4 ts uk lib' A A' (eqa lib' x))
    -> in_ext_ext lib (fun lib' x => forall a a' (e : eqa lib' x a a'), type_sys_props4 ts uk lib' (substc a v B) (substc a' v' B') (eqb lib' x a a' e))
    -> per_w_bar ts uk lib0 T T' eqa'
    -> per_w_bar ts uk lib0 T T' eqb'
    -> eqa' t1 t2
    -> eqb' t1 t2.
Proof.
  introv ext comp tya tyb pera perb eqs.
  unfold per_w_bar, type_family_ext in *; exrepnd.
...
Lemma local_per_bar_per_w_bar {o} :
  forall (ts : cts(o)) uk lib T A v B A' v' B' (eqa : lib-per(lib,o)) (eqb : lib-per-fam(lib,eqa,o)),
    ...
    -> T ===>(lib) (mkc_w A v B)
    -> local_ts_T (per_bar (per_w_bar ts)) uk lib T.
Proof.
...

  {
    ...
    eapply (weq_bar_change_pers2 ts uk lib lib'2 T T' A A' v v' B B');
      auto; try exact imp0; eauto; eauto 3 with slow.
  }
Qed.
Hint Resolve local_per_bar_per_w_bar : slow.

Lemma local_per_bar_per_w_bar2 {o} :
  forall (ts : cts(o)) uk lib T A v B A' v' B' (eqa : lib-per(lib,o)) (eqb : lib-per-fam(lib,eqa,o)),
    in_ext_ext lib (fun lib' x => type_sys_props4 ts uk lib' A' A (eqa lib' x))
    -> in_ext_ext
         lib
         (fun lib' x =>
            forall a a' (e : eqa lib' x a a'),
              type_sys_props4 ts uk lib' (substc a v' B') (substc a' v B) (eqb lib' x a a' e))
    -> T ===>(lib) (mkc_w A v B)
    -> local_ts_T2 (per_bar (per_w_bar ts)) uk lib T.
Proof.
  introv tsa tsb comp eqiff alla.
  unfold per_bar in *.
...

  {
    ...
    eapply (weq_bar_change_pers3
              ts uk lib lib'2 T0 T A A' v v' B B');
      auto; try exact imp0; eauto; eauto 3 with slow.
  }
Qed.
Hint Resolve local_per_bar_per_w_bar2 : slow.


(* ====== dest lemmas ====== *)

Lemma dest_close_per_w_l {o} :
...
Proof.
  ...
  eapply local_per_bar_per_w_bar; spcast; eauto.
...
Proof.
  ...
  eapply local_per_bar_per_w_bar2; spcast; eauto.
  eapply in_open_bar_ext_comb;[|exact reca];clear reca.
  apply in_ext_ext_implies_in_open_bar_ext; introv reca.
  eapply (reca (raise_lib_per eqa e)); eauto 3 with slow.
Qed.
