...
Proof.
  ...
  pose proof (teq a a a) as q; destruct q as [q q']; clear q'.
  autodimp q hyp; repnd; dands; eauto 2 with nequality;[].

  pose proof (teq b b b) as w; destruct w as [w' w]; clear w'.
