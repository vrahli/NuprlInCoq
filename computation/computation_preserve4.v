...
Lemma compute_at_most_k_steps_S2 {o} :
  forall (lib : pre_library) (n : nat) (t : @NTerm o),
...
Inductive computes_in_1step {p} : @pre_library p -> @NTerm p -> @NTerm p -> [univ] :=
| c1step_nc :
...
Inductive computes_in_kstep_alpha {p} : @pre_library p -> nat -> @NTerm p -> @NTerm p -> [univ]:=
...
Inductive computes_in_kstep {p} : @pre_library p -> nat -> @NTerm p -> @NTerm p -> [univ]:=
...
Lemma noncan_tricot_abs {p} :
  forall (lib : @pre_library p) ab lbt,
