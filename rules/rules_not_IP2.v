...
Definition IP {o} (A B n : NVar) (i : nat) : @NTerm o :=
  mk_all
    ...
    (mk_all
       ...
       B
       (mk_fun
          (mk_fun (mk_squash (mk_var A)) (mk_exists mk_tnat n (mk_apply (mk_var B) (mk_var n))))
          (mk_exists mk_tnat n (mk_fun (mk_squash (mk_var A)) (mk_apply (mk_var B) (mk_var n)))))).
...
Check lsubstc_vars_mk_var_as_mkcv2.
Search lsubstc_vars mk_squash.
autorewrite with slow.
