...
Proof.
  ...
  generalize (param_w_ind3
                ...
                (fun p1 p2 t1 t2 =>
                   forall p3,
                     equality p1 p3 (lsubstc P wP s1a cvP)
                     -> forall t3,
                          equality t1 t3
...
*)
  ...
  assert (cover_vars
         ...
         as cv
         by (apply cover_vars_change_sub with (sub1 := snoc (snoc (snoc s1a0 (q,t7)) (a, t5)) (f, t0)); auto;
             allrw dom_csub_snoc; simpl; allapply similarity_dom; repnd; allrw; auto).
