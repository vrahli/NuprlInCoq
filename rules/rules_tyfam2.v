...
Definition rule_tyfam_equality2_concl {o}
           C (a1 a2 b1 b2 : @NTerm o) (x1 x2 : NVar) i H :=
  mk_baresequent
    H
    (mk_conclax (mk_equality (C a1 x1 b1) (C a2 x2 b2) (@mk_uni o i))).

Definition rule_tyfam_equality2_hyp1 {o}
           (a1 a2 : @NTerm o) e1 i H :=
  mk_baresequent
    H
    (mk_concl (mk_equality a1 a2 (mk_uni i)) e1).

Definition rule_tyfam_equality2_hyp2 {o}
           (a1 : @NTerm o) b1 b2 e2 x1 x2 y i H :=
  mk_baresequent
    (snoc H (mk_hyp y a1))
    (mk_concl
       (mk_equality
...
Definition rule_tyfam_equality2 {p}
           C
           ...
           (H   : @barehypotheses p) :=
  mk_rule
    (rule_tyfam_equality2_concl C a1 a2 b1 b2 x1 x2 i H)
    [
      rule_tyfam_equality2_hyp1 a1 a2 e1 i H,
      rule_tyfam_equality2_hyp2 a1 b1 b2 e2 x1 x2 y i H
    ]
    [ sarg_var y ].

Lemma rule_tyfam_equality2_true3 {o} :
  forall lib C Cc (a1 a2 b1 b2 : @NTerm o) e1 e2
         (x1 x2 y : NVar)
         (i   : nat)
         (H   : barehypotheses),
  ...
  forall eqC : (forall a1 a2 v1 v2 b1 b2 i,
    ...
    rule_true3 lib (rule_tyfam_equality2
                      C a1 a2 b1 b2
                      e1 e2
                      x1 x2 y
                      i
                      H).
Proof.
  unfold rule_tyfam_equality2, rule_true3, wf_bseq, closed_type_baresequent, closed_extract_baresequent; simpl.
  intros.
  repnd.
  ...
  {
    clear hyp1 hyp2.
    unfold wf_csequent, wf_sequent, wf_concl, closed_extract; simpl.
  ...
  teq_and_eq (@mk_uni o i) (C a1 x1 b1) (C a2 x2 b2) s1 s2 H;
...
Lemma rule_tyfam_equality2_true {pp} :
  ...
  forall eqC : (forall a1 a2 v1 v2 b1 b2 i,
                  ...
                  <=> (equality lib a1 a2 (mkc_uni i)
                       # (forall a a',
                            equality lib a a' a1
                            -> equality lib (substc a v1 b1) (substc a' v2 b2) (mkc_uni i)))),
    rule_true lib (rule_tyfam_equality2
                     C a1 a2 b1 b2
                     e1 e2
                     x1 x2 y
                     i
