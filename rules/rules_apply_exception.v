...
Lemma rule_apply_exception_cases_true {o} :
  forall lib  (a b T t u : NTerm),
  forall x : NVar,
  forall H : @barehypotheses o,
    rule_true lib (rule_apply_exception_cases H  a b T t u x).
Proof.
  unfold rule_apply_exception_cases, rule_true, closed_type_baresequent,
